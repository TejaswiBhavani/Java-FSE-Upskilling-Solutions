...
public class OrmLearnApplication {
    ...
    private static void testAddCountry() {
        ...
        try {
            Country savedCountry = countryService.findCountryByCode("MM");
    ...
    private static void testUpdateCountry() {
        ...
        countryService.updateCountry("MM", "My Updated Country");
    ...
    private static void testDeleteCountry() {
        ...
        try {
            // This should throw an exception if deletion was successful
            countryService.findCountryByCode("MM");
        } catch (CountryNotFoundException e) {
            LOGGER.debug("Country successfully deleted. Exception message: {}", e.getMessage());
        }
